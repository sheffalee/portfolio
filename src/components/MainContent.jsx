    ...
    <div className='about-page'> 
        <h2>About Me</h2>
               <h4>
                ...
                <h4>My interests in building software has no bounds! I am good at <span class="purple">Frontend Development, DSA</span>  and also in <span class="purple">Backend Development</span>. 
                </h4>
